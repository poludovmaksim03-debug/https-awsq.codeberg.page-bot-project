...
<body>
    ...
    <script type="./https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@4.0.0/dist/tf.min.js"></script>
    <script type="./https://cdn.jsdelivr.net/npm/tesseract.js@4.1.1/dist/tesseract.min.js"></script>
    <script type="./js/scanner.js"></script>
    <script type="./js/recognizer.js"></script>
    <script type="./js/ai-processor.js"></script>
    <script type="./js/chatbot.js"></script>
